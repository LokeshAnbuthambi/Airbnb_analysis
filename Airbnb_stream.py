...
def datafr():
    df = pd.read_csv("F:/DS/MDTM20/VS Code/Airbnb.csv")
    return df
...
if select == "Home":
    ...
    with col1:
        image1 = Image.open("F:/DS/MDTM20/VS Code/airbnb-icon.png")
        st.image(image1)
...
if select == "Data Exploration":
    ...
    with tab1:
        ...
        with col1:
            ...
            fig_do_bar = px.bar(df_do_bar, x = 'bed_type', y = ['minimum_nights', 'maximum_nights'], title = 'MINIMUM NIGHTS AND MAXIMUM NIGHTS',
                                hover_data = "price", barmode = 'group', color_discrete_sequence = px.colors.sequential.Rainbow, width = 600, height = 500)
        ...
        with col2:
            ...
            fig_do_bar_2 = px.bar(df_do_bar_2, x = 'bed_type', y = ['bedrooms', 'beds', 'accommodates'], title = 'BEDROOMS AND BEDS ACCOMMODATES', hover_data = "price",
    ...
    with tab2:
        ...
        def datafr():
            df_a = pd.read_csv("F:/DS/MDTM20/VS Code/Airbnb.csv")
            return df_a
        ...
        with col1:
            ...
            df_a_sunb_30 = px.sunburst(df2_a, path = ["room_type","bed_type","is_location_exact"], values = "availability_30", width = 600, height = 500,
        ...
        with col2:
            ...
            df_a_sunb_60 = px.sunburst(df2_a, path = ["room_type","bed_type","is_location_exact"], values = "availability_60", width = 600, height = 500,
        ...
        with col1:
            ...
            df_a_sunb_90 = px.sunburst(df2_a, path = ["room_type","bed_type","is_location_exact"], values ="availability_90", width = 600, height = 500,
                                       title = "Availability_90", color_discrete_sequence = px.colors.sequential.Aggrnyl_r)
            st.plotly_chart(df_a_sunb_90)

        with col2:

            df_a_sunb_365 = px.sunburst(df2_a, path = ["room_type","bed_type","is_location_exact"], values = "availability_365", width = 600, height = 500,
    ...
    with tab3:
        ...
        df_val_sel_corr= df_val_sel.drop(columns = ["listing_url","name", "property_type",                 
                                            "room_type", "summary", "description", "space",
                                            "bed_type","cancellation_policy","neighborhood_overview",
                                            "notes", "transit", "access", "interaction",
                                            'house_rules', 'property_type', 'room_type', 'bed_type', 'cancellation_policy',
